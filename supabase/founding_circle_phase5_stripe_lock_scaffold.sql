-- PHASE 5 — Stripe Lock Scaffold (Before Stripe Goes Live)
--
-- Goals:
-- 1) Persist pricing_lock forever (cannot be cleared once set)
-- 2) Add Stripe reference columns (customer/subscription/status)
--
...
begin
  ...
  -- Optional: prevent founders from being downgraded accidentally.
