...
exports.MAGIC_TECHNIQUE_TERMS = exports.MAGIC_DICTIONARY_TERMS = exports.conventions = exports.clubs = exports.publications = exports.MAGICIAN_CHAT_TOOLS = exports.LIVE_REHEARSAL_TOOLS = exports.MAGICIAN_PROMPTS = exports.AUDIENCE_PROMPTS = exports.PROFESSIONAL_FEATURES = exports.SEMI_PRO_FEATURES = exports.AMATEUR_FEATURES = exports.PERSONAS = exports.MAGIC_THEORY_CURRICULUM = exports.MAGIC_THEORY_TUTOR_SYSTEM_INSTRUCTION = exports.ILLUSION_BLUEPRINT_SYSTEM_INSTRUCTION = exports.VIDEO_REHEARSAL_SYSTEM_INSTRUCTION = exports.PERSONA_SIMULATOR_SYSTEM_INSTRUCTION = exports.DIRECTOR_MODE_SYSTEM_INSTRUCTION = exports.ANGLE_RISK_ANALYSIS_SYSTEM_INSTRUCTION = exports.ASSISTANT_STUDIO_SYSTEM_INSTRUCTION = exports.CONTRACT_GENERATOR_SYSTEM_INSTRUCTION = exports.MARKETING_ASSISTANT_SYSTEM_INSTRUCTION = exports.MENTALISM_ASSISTANT_SYSTEM_INSTRUCTION = exports.GOSPEL_MAGIC_SYSTEM_INSTRUCTION = exports.MAGIC_NEWS_SYSTEM_INSTRUCTION = exports.MAGIC_RESEARCH_SYSTEM_INSTRUCTION = exports.MAGICAL_STORY_SYSTEM_INSTRUCTION = exports.ASK_MAGICIAN_SYSTEM_INSTRUCTION = exports.AI_TASK_SUGGESTER_SYSTEM_INSTRUCTION = exports.IN_TASK_PATTER_SYSTEM_INSTRUCTION = exports.PATTER_ENGINE_SYSTEM_INSTRUCTION = exports.EFFECT_GENERATOR_SYSTEM_INSTRUCTION = exports.MAGICIAN_LIVE_REHEARSAL_SYSTEM_INSTRUCTION = exports.MAGICIAN_SYSTEM_INSTRUCTION = exports.AUDIENCE_SYSTEM_INSTRUCTION = exports.GUEST_USER = exports.APP_VERSION = exports.ADMIN_EMAIL = void 0;
var genai_1 = require("@google/genai");
var icons_1 = require("./components/icons");
exports.ADMIN_EMAIL = 'admin@magicaiwizard.com';
// Keep this in sync with your current git benchmark/tag so the UI + SW cache are coherent.
exports.APP_VERSION = 'v0.98.5-beta';
...
exports.PERSONAS = [
    ...
    },
    {
        ...
        icon: icons_1.ThumbUpIcon,
    },
];
exports.AMATEUR_FEATURES = [
...
exports.MAGIC_DICTIONARY_TERMS = [
    {
        term: 'Misdirection',
        category: 'Theory',
        skillLevel: 'Beginner',
        definition: 'Guiding an audience’s attention and thoughts so they focus on what matters and overlook what doesn’t.',
        whyItMatters: 'Magic lives and dies by attention. Strong misdirection makes effects feel effortless and fair. Weak misdirection makes audiences burn the hands, rewind moments, and feel suspicious.',
        beginnerMistakes: [
    ...
    },
    {
        ...
        category: 'Theory',
        skillLevel: 'Pro',
        definition: 'Creating a time gap between an important moment and the audience’s suspicion of it.',
        whyItMatters: 'Time misdirection lowers “heat.” Actions feel like they happened long ago, reducing suspicion and making the final reveal feel more impossible in hindsight.',
        beginnerMistakes: [
    ...
    },
    {
        ...
        whyItMatters: 'Clean beats create clarity. When beats blur together, routines feel rushed or confusing, and audiences become suspicious because they can’t track what changed.',
        beginnerMistakes: [
    ...
    },
    {
        ...
        category: 'Performance',
        skillLevel: 'Pro',
        definition: 'A relaxed moment when attention naturally drops—often right after a laugh, applause, or completed action.',
        whyItMatters: 'The offbeat is a natural “low attention” moment. It’s useful for resetting focus, changing gears, and transitioning without feeling sneaky.',
        beginnerMistakes: [
    ...
    },
    {
        ...
        category: 'Stagecraft',
        skillLevel: 'Beginner',
        definition: 'How dependent an effect is on audience viewpoint (sightlines) to look clean and fair.',
        whyItMatters: 'Angle issues are one of the fastest ways to lose trust. If spectators see something “off” from the side, the mystery collapses—even if the front view looks perfect.',
        beginnerMistakes: [
    ...
    },
    {
        ...
        whyItMatters: 'Reset time determines what’s practical for real gigs—especially walk-around, table-hopping, and repeat sets. Low-reset material makes shows smoother and more bookable.',
        beginnerMistakes: [
    ...
    },
    {
        ...
        category: 'Performance',
        skillLevel: 'Pro',
        definition: 'A planned recovery option that keeps the routine entertaining and credible if something doesn’t go as expected.',
        whyItMatters: 'Outs protect confidence and audience trust. A strong out keeps momentum moving and prevents a minor issue from becoming a show-stopper.',
        beginnerMistakes: [
    ...
    },
    {
        ...
        category: 'Psychology',
        skillLevel: 'Beginner',
        definition: 'How you present an action or moment so the audience interprets it the way you intend.',
        whyItMatters: 'Framing shapes meaning. The same action can feel suspicious or natural depending on the story, motivation, and persona behind it.',
        beginnerMistakes: [
    ...
    },
    {
        ...
        category: 'Mentalism',
        skillLevel: 'Pro',
        definition: 'A performance approach where different audience members experience different versions of the same moment.',
        whyItMatters: 'Dual reality can create massive impact by leveraging perspective and interpretation. It must be handled ethically so audiences feel amazed—not confused or excluded.',
        beginnerMistakes: [
    ...
    },
    {
        ...
        skillLevel: 'Beginner',
        definition: 'Choosing the right spectator to participate so the routine stays safe, clear, and entertaining.',
        whyItMatters: 'The right volunteer keeps pacing strong and protects the audience vibe. The wrong volunteer can derail clarity, timing, and confidence.',
        beginnerMistakes: [
    ...
    // --- Expanded Dictionary Terms (Batch 2) ---
    {
        ...
        whyItMatters: 'When you look convinced, the audience relaxes. When you look unsure, they become detectives. Conviction often determines whether an effect feels like magic or a puzzle.',
        beginnerMistakes: [
    ...
    },
    {
        ...
        whyItMatters: 'If the audience is confused, they can’t be amazed. Clear structure and clear language create stronger reactions and cleaner memories of the impossible moment.',
        beginnerMistakes: [
    ...
    },
    {
        ...
        whyItMatters: 'Good pacing keeps attention locked. Poor pacing either drags (people drift) or rushes (people suspect or miss key moments).',
        beginnerMistakes: [
    ...
    },
    {
        ...
        whyItMatters: 'Audiences often need permission to react. A clean cue increases applause and makes the ending feel stronger without begging for it.',
        beginnerMistakes: [
    ...
    },
    {
        ...
        whyItMatters: 'A button makes the audience feel the routine is complete. It prevents awkward trailing off and strengthens reactions.',
        beginnerMistakes: [
    ...
    },
    {
        ...
        whyItMatters: 'A great show feels like a journey. Strong flow prevents dead spots, balances energy, and helps the audience remember the best moments.',
        beginnerMistakes: [
            'Starting too slow',
    ...
    },
    {
        ...
        whyItMatters: 'Good blocking increases clarity and reduces angle issues. It also makes you look more confident and professional.',
        beginnerMistakes: [
    ...
    },
    {
        ...
        whyItMatters: 'Even perfect technique can fail if someone has the wrong view. Planning sightlines protects the illusion and audience trust.',
        beginnerMistakes: [
    ...
    },
    {
        ...
        skillLevel: 'Beginner',
        definition: 'How long it takes to get an effect ready to perform again after it’s done.',
        whyItMatters: 'Reset determines what’s practical for walk-around, repeat shows, and encores. Lower reset time usually means smoother shows and higher booking value.',
        beginnerMistakes: [
    ...
    },
    {
        ...
        category: 'Theory',
        skillLevel: 'Pro',
        definition: 'A high-level approach to guiding choices and decisions by shaping context, expectations, and attention—without making the participant feel controlled.',
        whyItMatters: 'When used ethically, psychological forces can make interactions feel personal and impossible while keeping the performance playful and fair. The real power is in framing and participant experience, not “gotcha” moments.',
        beginnerMistakes: [
    ...
    },
    {
        ...
        definition: 'Using a story arc (setup → tension → payoff) to connect moments so a routine feels like one cohesive experience, not separate tricks.',
        whyItMatters: 'Narrative makes magic memorable. It gives the audience an emotional thread to follow, increases clarity, and creates stronger applause moments because the payoff feels earned.',
        beginnerMistakes: [
    ...
    },
    {
        ...
        whyItMatters: 'The goal is control, not confrontation. A calm redirect protects momentum and makes you look professional.',
        beginnerMistakes: [
...
exports.MAGIC_TECHNIQUE_TERMS = [
    // --- Sleights ---
    {
        term: 'Double Lift',
        category: 'Sleights',
        definition: 'A broad family of techniques where two cards are handled as one to create the impression of a single, ordinary action.',
        historicalNote: 'Popularized through 20th-century card literature; the “double” became a foundational utility move in close-up card magic.',
    },
    {
        term: 'Elmsley Count',
        category: 'Sleights',
        definition: 'A false count used to display a small packet while concealing one card’s true status (for example, a face or position).',
        historicalNote: 'Associated with Alex Elmsley; it became central to packet effects and modern small-packet constructions.',
    },
    {
        term: 'Classic Pass',
        category: 'Sleights',
        definition: 'A secret, in-the-hands control concept that retains an apparently fair condition while changing the apparent position of a selection.',
        historicalNote: 'One of the most discussed “controls” in card magic history; valued for its directness when used under strong misdirection.',
    },
    {
        term: 'Top Change',
        category: 'Sleights',
        definition: 'A utility switching concept where one item is exchanged for another under the cover of natural timing and attention control.',
        historicalNote: 'A classic tool in sleight-of-hand; long used as a “quiet” switch when framed as a normal gesture or beat.',
    },
    {
        term: 'False Transfer',
        category: 'Sleights',
        definition: 'A family of actions that appear to place an object into a hand while the object remains elsewhere (or is retained).',
        historicalNote: 'Core to coin and ball work; the modern emphasis is on conviction, rhythm, and a believable “after” moment.',
    },
    // --- Forces ---
    {
        term: 'Classic Force',
        category: 'Forces',
        definition: 'A selection strategy where the participant feels free to choose, while the performer guides toward a specific outcome.',
        historicalNote: 'Considered a benchmark of audience management and timing; often framed as an art rather than a single technique.',
    },
    {
        term: 'Riffle Force',
        category: 'Forces',
        definition: 'A family of card-selection procedures using a riffle or dribble action to create the perception of an open choice.',
        historicalNote: 'Popular in practical working repertoires; valued for speed and repeatability under performance conditions.',
    },
    {
        term: 'Hindu Shuffle Force',
        category: 'Forces',
        definition: 'A selection procedure built around a shuffle action that maintains control of outcomes while appearing casual.',
        historicalNote: 'Became common through global card handling traditions; frequently used in strolling and informal close-up settings.',
    },
    {
        term: 'Psychological Force',
        category: 'Forces',
        definition: 'A choice-guiding approach that relies on context, language, and expectation rather than physical control.',
        historicalNote: 'A modern category influenced by mentalism and behavioral framing; results vary, so performers often build “outs.”',
    },
    // --- Gimmicks ---
    {
        term: 'Thumb Tip',
        category: 'Gimmicks',
        definition: 'A classic utility prop used to enable transformations, vanishes, and productions in a way that looks impossibly clean when well managed.',
        historicalNote: 'A staple of practical magic for decades; its longevity comes from versatility and the power of natural handling.',
    },
    {
        term: 'Pull',
        category: 'Gimmicks',
        definition: 'A concealed assistant device designed to remove or reposition a small object at a controlled moment.',
        historicalNote: 'Historically tied to stage and parlor production work; modern versions evolved alongside improved materials and clothing styles.',
    },
    {
        term: 'Invisible Thread',
        category: 'Gimmicks',
        definition: 'A family of fine filaments used to create the illusion of movement or animation under careful lighting and audience conditions.',
        historicalNote: 'Used for levitations and animations throughout modern magic; success depends heavily on venue conditions and audience sightlines.',
    },
    {
        term: 'Flap Card',
        category: 'Gimmicks',
        definition: 'A gaffed card category that allows a quick, visual change or reveal under controlled handling and viewing conditions.',
        historicalNote: 'A long-running close-up utility concept; variations exist across creators and eras, often optimized for clarity and contrast.',
    },
    // --- Stage Terminology ---
    {
        term: 'Sightlines',
        category: 'Stage Terminology',
        definition: 'The angles from which the audience can see the performer and stage area; crucial for staging, concealment, and clarity.',
        historicalNote: 'A foundational theatre concept adopted into magic; “clean sightlines” became a standard planning phrase for directors and illusion designers.',
    },
    {
        term: 'Black Art',
        category: 'Stage Terminology',
        definition: 'A broad staging principle that uses controlled contrast and environment design to keep attention on what the audience should perceive.',
        historicalNote: 'Associated with stagecraft traditions and classic illusion staging; modern practice emphasizes ethics and venue suitability.',
    },
    {
        term: 'Servante',
        category: 'Stage Terminology',
        definition: 'A concealed working area attached to or behind a table that supports efficient handling and clean displays.',
        historicalNote: 'A standard tool in professional close-up and parlor work; valued because it improves flow and reduces “dead time.”',
    },
    {
        term: 'Cue Stack',
        category: 'Stage Terminology',
        definition: 'A planned sequence of technical cues (music, lights, visuals) organized to support pacing, reveals, and transitions.',
        historicalNote: 'Borrowed from theatre and live events; modern performers often manage cues through compact audio systems and show control apps.',
    },
    // --- Equipment ---
    {
        term: 'Close-Up Mat',
        category: 'Equipment',
        definition: 'A working surface that improves visibility, control, and sound management for small-object routines.',
        historicalNote: 'Evolved from card-table coverings and performance surfaces; now common in professional close-up and instructional presentations.',
    },
    {
        term: 'Parlor Table',
        category: 'Equipment',
        definition: 'A portable table designed for visibility, stability, and quick access in small-stage or stand-up performances.',
        historicalNote: 'A practical response to real-world venues; modern designs emphasize portability and integrated storage.',
    },
    {
        term: 'Bodypack Microphone',
        category: 'Equipment',
        definition: 'A wireless microphone system worn on the performer to ensure consistent audio clarity for spoken presentations.',
        historicalNote: 'Adopted widely as venues grew noisier and expectations rose; strong audio is now a baseline professional standard.',
    },
    // --- Method Classifications ---
    {
        term: 'Equivoque',
        category: 'Method Classifications',
        definition: 'A decision-tree framing method where multiple apparent choices can be guided toward a desired outcome while maintaining participant comfort.',
        historicalNote: 'A long-standing mentalism structure; modern framing emphasizes fairness, clarity, and minimizing “procedural” feel.',
    },
    {
        term: 'One-Ahead Principle',
        category: 'Method Classifications',
        definition: 'A high-level structure where the performer stays one step ahead in information or planning, allowing progressive revelations.',
        historicalNote: 'A classic backbone in mentalism; prized for reliability and adaptability when combined with strong presentation.',
    },
];
