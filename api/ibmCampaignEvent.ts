...
const ALLOWED_EVENTS = new Set(['ibm_landing_view', 'ibm_cta_click', 'ibm_trial_form_submit', 'ibm_signup_redirect']);
...
export default async function handler(req: any, res: any) {
  ...
  const eventType = cleanText(body?.event_type, 80) || 'ibm_trial_form_submit';
