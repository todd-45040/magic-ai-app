  ...
  const renderPathCards = () => (
    <>
      <div className="mx-auto max-w-3xl text-center">
        ...
        <h1 className="bg-gradient-to-r from-fuchsia-300 via-purple-300 to-violet-400 bg-clip-text text-4xl font-black tracking-tight text-transparent drop-shadow-[0_0_24px_rgba(168,85,247,0.28)] sm:text-5xl md:text-5xl md:text-6xl font-bold whitespace-nowrap leading-tight tracking-tight whitespace-nowrap">Welcome to the Magicians' AI Wizard.</h1>
