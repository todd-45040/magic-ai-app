...
import type { ChatMessage, MagicTheoryModule, MagicTheoryLesson, MagicTheoryConcept } from '../types';
...
const MagicTheoryTutor: React.FC = () => {
    ...
    const startConcept = async (moduleIndex: number, lessonIndex: number, conceptIndex: number) => {
        ...
        const response = await generateResponse("Let's begin with this concept.", systemInstruction);
    ...
    const handleSend = async () => {
        ...
        const response = await generateResponse(userInput, systemInstruction, history);
