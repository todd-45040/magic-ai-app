...
const VideoRehearsal: React.FC<VideoRehearsalProps> = ({ onIdeaSaved }) => {
    ...
    const handleAnalyze = async () => {
        ...
        try {
          const response = await generateResponse(simulationPrompt, VIDEO_REHEARSAL_SYSTEM_INSTRUCTION);
