...
import type { IllusionBlueprintResponse } from '../types';
...
const IllusionBlueprint: React.FC<IllusionBlueprintProps> = ({ onIdeaSaved }) => {
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            const artPromise = generateImage(artPrompt, '16:9');
            const blueprintPromise = generateStructuredResponse(textPrompt, ILLUSION_BLUEPRINT_SYSTEM_INSTRUCTION, blueprintSchema);
