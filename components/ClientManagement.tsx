            ...
            <div className="w-full max-w-lg bg-slate-800 border border-purple-500 rounded-lg shadow-2xl" onClick={(e) => e.stopPropagation()}>
                <form id="client-form" onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div><label htmlFor="name" className="block text-sm font-medium text-slate-300 mb-1">Name*</label><input className="bg-slate-900/70 text-slate-100 placeholder:text-slate-400 border border-slate-600 focus:border-purple-500 focus:ring-1 focus:ring-purple-500/50 " id="name" type="text" value={name} onChange={e => setName(e.target.value)} required autoFocus className="w-full px-3 py-2 bg-slate-900 border border-slate-600 rounded-md" /></div>
                        <div><label htmlFor="company" className="block text-sm font-medium text-slate-300 mb-1">Company</label><input className="bg-slate-900/70 text-slate-100 placeholder:text-slate-400 border border-slate-600 focus:border-purple-500 focus:ring-1 focus:ring-purple-500/50 " id="company" type="text" value={company} onChange={e => setCompany(e.target.value)} className="w-full px-3 py-2 bg-slate-900 border border-slate-600 rounded-md" /></div>
                        <div><label htmlFor="email" className="block text-sm font-medium text-slate-300 mb-1">Email</label><input className="bg-slate-900/70 text-slate-100 placeholder:text-slate-400 border border-slate-600 focus:border-purple-500 focus:ring-1 focus:ring-purple-500/50 " id="email" type="email" value={email} onChange={e => setEmail(e.target.value)} className="w-full px-3 py-2 bg-slate-900 border border-slate-600 rounded-md" /></div>
                        <div><label htmlFor="phone" className="block text-sm font-medium text-slate-300 mb-1">Phone</label><input className="bg-slate-900/70 text-slate-100 placeholder:text-slate-400 border border-slate-600 focus:border-purple-500 focus:ring-1 focus:ring-purple-500/50 " id="phone" type="tel" value={phone} onChange={e => setPhone(e.target.value)} className="w-full px-3 py-2 bg-slate-900 border border-slate-600 rounded-md" /></div>
                    </div>
                    <div><label htmlFor="notes" className="block text-sm font-medium text-slate-300 mb-1">Notes</label><textarea className="bg-slate-900/70 text-slate-100 placeholder:text-slate-400 border border-slate-600 focus:border-purple-500 focus:ring-1 focus:ring-purple-500/50 " id="notes" rows={3} value={notes} onChange={e => setNotes(e.target.value)} placeholder="e.g., Met at the 2026 convention. Interested in a holiday party booking." className="w-full px-3 py-2 bg-slate-900 border border-slate-600 rounded-md" /></div>
