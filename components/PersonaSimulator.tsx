...
const PersonaSimulator: React.FC<PersonaSimulatorProps> = ({ onIdeaSaved }) => {
    ...
    const handleStartSimulation = async () => {
        ...
        const response = await generateResponse(script, systemInstruction);
    ...
    const handleSend = async () => {
        ...
        const response = await generateResponse(input, systemInstruction, history);
