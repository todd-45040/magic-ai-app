    ...
    const features = [
        {
            icon: WandIcon,
            title: 'AI Assistant',
            description: "Choose a tool to start, or ask a question. Recommended tools are highlighted to help you begin fast.",
...

        {
            ...
            description: "To keep the service reliable and control AI costs, each plan includes a daily allowance of AI actions plus a short per‑minute burst limit to prevent rapid repeat requests.",
            proTip: "Watch the Usage Meter in the header to see your remaining allowance for today. Daily limits reset at midnight (UTC). If you hit the burst limit, wait about a minute and try again."
        },
        {
            icon: BlueprintIcon,
