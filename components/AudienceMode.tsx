...
import { AUDIENCE_SYSTEM_INSTRUCTION, AUDIENCE_PROMPTS, publications, clubs, conventions, ASK_MAGICIAN_SYSTEM_INSTRUCTION, MAGICAL_STORY_SYSTEM_INSTRUCTION } from '../constants';
...
const AudienceMode: React.FC<AudienceModeProps> = ({ onBack }) => {
  ...
  const handleSend = async (prompt?: string) => {
    ...
    const response = await generateResponse(userMessage, AUDIENCE_SYSTEM_INSTRUCTION);
  ...
  const handleAskQuestion = async (e: React.FormEvent) => {
    ...
    const answer = await generateResponse(prompt, ASK_MAGICIAN_SYSTEM_INSTRUCTION);
  ...
  const handleCreateStory = async (e: React.FormEvent) => {
    ...
    const story = await generateResponse(prompt, MAGICAL_STORY_SYSTEM_INSTRUCTION);
