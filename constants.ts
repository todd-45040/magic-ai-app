...
export const APP_VERSION = 'v0.98.5-beta';
...
- Signal the magician…
- Reset the table…
- If the volunteer hesitates…

Prefer blocking-style wording and stage-action verbs so the notes sound like real rehearsal documentation.
