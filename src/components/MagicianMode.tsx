...
// (AngleRiskForm, RehearsalCoachingForm, InnovationEngineForm)
...
// ... (LoadingIndicator, ChatMessages, ChatView, IdentifyTab, PublicationsTab, CommunityTab - Unchanged) ...
...
const MagicianMode: React.FC<MagicianModeProps> = ({ onBack, user, onUpgrade, onLogout }) => {
  ...
  const handleUpgrade = (tier: 'amateur' | 'semi-pro' | 'professional') => {
    // Note: The onUpgrade signature will need adjusting in the parent if semi-pro is passed here
    onUpgrade(tier);
