...
const MagicArchives: React.FC<MagicArchivesProps> = ({ onIdeaSaved }) => {
    ...
    const handleSearch = async (searchQuery?: string) => {
        ...
        try {
            const response = await generateResponse(currentQuery, MAGIC_RESEARCH_SYSTEM_INSTRUCTION);
            setResult(response);
        } catch (err) {
        ...
        <div className="flex-1 flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-4 md:p-6">
                {isLoading ? (
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center h-full text-center text-slate-500">
